...
bool qjackctlPaletteForm::namedPalette ( const QString& name, QPalette& pal ) const
{
...
QStringList qjackctlPaletteForm::namedPaletteList (void) const
{
...
QString qjackctlPaletteForm::namedPaletteConf ( const QString& name ) const
{
	return namedPaletteConf(m_settings, name);
}


QString qjackctlPaletteForm::namedPaletteConf (
...
void qjackctlPaletteForm::addNamedPaletteConf (
...
void qjackctlPaletteForm::deleteNamedPaletteConf ( const QString& name )
{
	if (m_settings) {
...
bool qjackctlPaletteForm::loadNamedPaletteConf (
...
bool qjackctlPaletteForm::saveNamedPaletteConf (
...
bool qjackctlPaletteForm::loadNamedPalette (
...
bool qjackctlPaletteForm::saveNamedPalette (
