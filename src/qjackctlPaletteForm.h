...
#ifndef __qjackctlPaletteForm_h
#define __qjackctlPaletteForm_h
...
namespace Ui { class qjackctlPaletteForm; }


class qjackctlPaletteForm: public QDialog
{
	Q_OBJECT

public:

	qjackctlPaletteForm(QWidget *parent = nullptr,
		const QPalette& pal = QPalette());

	virtual ~qjackctlPaletteForm();
...
private:
	...
	Ui::qjackctlPaletteForm *p_ui;
	Ui::qjackctlPaletteForm& m_ui;
...
class qjackctlPaletteForm::PaletteModel : public QAbstractTableModel
{
	Q_OBJECT
...
class qjackctlPaletteForm::ColorDelegate : public QItemDelegate
{
public:
...
class qjackctlPaletteForm::ColorButton : public QPushButton
{
	Q_OBJECT
...
class qjackctlPaletteForm::ColorEditor : public QWidget
{
	Q_OBJECT
...
private:
	...
	qjackctlPaletteForm::ColorButton *m_button;
	bool  m_changed;
};
...
class qjackctlPaletteForm::RoleEditor : public QWidget
{
	Q_OBJECT
...
#endif // __qjackctlPaletteForm_h

// end of qjackctlPaletteForm.h
